...
function filterRecognizedTsConfigTsNodeOptions(jsonObject) {
    if (jsonObject == null)
        return jsonObject;
    const { compiler, compilerHost, compilerOptions, emit, files, ignore, ignoreDiagnostics, logError, preferTsExts, tryTsExt, pretty, require, skipIgnore, transpileOnly, typeCheck, transpiler, } = jsonObject;
