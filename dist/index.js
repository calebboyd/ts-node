 ...
 */
const assertScriptCanLoadAsCJS = engineSupportsPackageTypeField
...
exports.DEFAULTS = {
    ...
    tryTsExt: util_1.yn(exports.env.TS_NODE_TRY_TS_EXT),
...
function create(rawOptions = {}) {
    ...
    const { configFilePath, config, tsNodeOptionsFromTsconfig } = configuration_1.readConfig(cwd, ts, rawOptions);
    const options = util_1.assign({}, exports.DEFAULTS, tsNodeOptionsFromTsconfig || {}, rawOptions);
    options.require = [
