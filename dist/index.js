...
exports.DEFAULTS = {
    ...
    tryTsExt: (0, util_1.yn)(exports.env.TS_NODE_TRY_TS_EXT),
...
function canDropJsExt(request, parentPath) {
    var _a;
    if ((0, util_1.isRelativeSpecifier)(request) && request.slice(-3) === '.js') {
        if (!parentPath)
            return true;
...
function create(rawOptions = {}) {
    ...
    if (transpiler) {
        ...
        const transpilerOptions = typeof transpiler === 'string' ? {} : (_k = transpiler[1]) !== null && _k !== void 0 ? _k : {};
